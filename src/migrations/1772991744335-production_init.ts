...
export class ProductionInit1772991744335 implements MigrationInterface {
  name = 'ProductionInit1772991744335';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "username" character varying(100) NOT NULL, "password" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "customerId" uuid, "tourGuideId" uuid, "isActive" boolean NOT NULL DEFAULT true, "isAdmin" boolean NOT NULL DEFAULT false, "refreshToken" text, "lastLogin" TIMESTAMP, "zaloId" character varying, "googleId" character varying, "facebookId" character varying(100), "loginProvider" character varying, "isVerified" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_f9740e1e654a5daddb82c60bd75" UNIQUE ("facebookId"), CONSTRAINT "REL_c6c520dfb9a4d6dd749e73b13d" UNIQUE ("customerId"), CONSTRAINT "REL_f0de33fc3ac11c639cbf862c21" UNIQUE ("tourGuideId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "destinations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "code" character varying(100) NOT NULL, "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "country" character varying(100), "region" character varying(100), "description" text, "latitude" numeric(12,8), "longitude" numeric(12,8), "bestTimeToVisit" character varying(100), "averageTemperature" character varying(100), "popularActivities" json, "viewCount" integer NOT NULL DEFAULT '0', "rating" integer, "status" character varying(50) NOT NULL, CONSTRAINT "UQ_30864aeaf404f4a6d3f816bd8c5" UNIQUE ("slug"), CONSTRAINT "PK_69c5e8db964dcb83d3a0640f3c7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tour_destinations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "tourId" uuid, "destinationId" uuid, CONSTRAINT "PK_144dfa7b85c2f7157cdc6819a8c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tour_prices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "code" character varying(50), "priceType" character varying(100) NOT NULL, "price" numeric(15,2) NOT NULL, "currency" character varying(255) NOT NULL, "tourDetailId" uuid, CONSTRAINT "UQ_1726732f891a39cf7556e4fb510" UNIQUE ("code"), CONSTRAINT "PK_fa3b74cad6c6c372f1d9a8ff96c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tour_details" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "tourId" uuid, "code" character varying(50), "startDay" TIMESTAMP NOT NULL, "endDay" TIMESTAMP NOT NULL, "startLocation" character varying(255) NOT NULL, "capacity" integer NOT NULL, "remainingSeats" integer NOT NULL, "status" character varying(50) NOT NULL, "tourGuideId" uuid, CONSTRAINT "UQ_3e91f83efc6a6e587929f7ecce0" UNIQUE ("code"), CONSTRAINT "REL_dd1b867580e7adf4398e598096" UNIQUE ("tourGuideId"), CONSTRAINT "PK_4fbc4688163d419042c12d76c7f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "booking_details" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "price" numeric(15,2) NOT NULL, "bookingId" uuid NOT NULL, "tourId" uuid NOT NULL, "quantity" integer NOT NULL, "subtotal" numeric(15,2) NOT NULL, "status" character varying(50) NOT NULL, "tourDetailId" uuid NOT NULL, "tourPriceId" uuid, CONSTRAINT "PK_53e6fd8cc006caf8abe22700012" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "news" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "code" character varying(10) NOT NULL, "titleVI" character varying(255) NOT NULL, "titleEN" character varying(255) NOT NULL, "contentVI" text NOT NULL, "contentEN" text NOT NULL, "url" character varying, "type" character varying(255) NOT NULL DEFAULT 'NEWS', "effectiveStartDate" TIMESTAMP WITH TIME ZONE, "effectiveEndDate" TIMESTAMP WITH TIME ZONE, "status" character varying(25) NOT NULL DEFAULT 'FRESHLY_CREATED', "rank" integer, "isVisible" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_0f77543ed4e5e510eae9e5c19be" UNIQUE ("code"), CONSTRAINT "PK_39a43dfcb6007180f04aff2357e" PRIMARY KEY ("id")); COMMENT ON COLUMN "news"."titleVI" IS 'Tiêu đề tin tức '; COMMENT ON COLUMN "news"."titleEN" IS 'Tiêu đề tin tức '; COMMENT ON COLUMN "news"."contentVI" IS 'Nội dung tin tức '; COMMENT ON COLUMN "news"."contentEN" IS 'Nội dung tin tức '; COMMENT ON COLUMN "news"."url" IS 'Link bài viết'; COMMENT ON COLUMN "news"."type" IS 'Loại tin tức'; COMMENT ON COLUMN "news"."effectiveStartDate" IS 'Ngày bắt đầu hiệu lực của bài viết'; COMMENT ON COLUMN "news"."effectiveEndDate" IS 'Ngày kết thúc hiệu lực của bài viết'; COMMENT ON COLUMN "news"."status" IS 'Trạng thái bài viết'; COMMENT ON COLUMN "news"."rank" IS 'Xếp hạng nổi bật bài viết'; COMMENT ON COLUMN "news"."isVisible" IS 'Trạng thái hiển thị của tin tức'`,
    );
    await queryRunner.query(
      `CREATE TABLE "travel_hint" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "month" integer NOT NULL, "locationName" character varying(255) NOT NULL, "description" text, "reason" text, "type" character varying(36) NOT NULL, "tags" text, "country" character varying(150), "city" character varying(150), "latitude" numeric(10,7), "longitude" numeric(10,7), CONSTRAINT "PK_51207f7a2e977fad25d740aaf2a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "file_archive" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "fileUrl" text NOT NULL, "fileName" text NOT NULL, "fileType" character varying(50), "fileSize" bigint, "description" text, "customerId" uuid, "tourGuideId" uuid, "reviewId" uuid, "newId" uuid, "bannerId" uuid, "blogPostId" uuid, "travelHintId" uuid, "destinationId" uuid, CONSTRAINT "REL_84d4cafda99986d7d21f981118" UNIQUE ("bannerId"), CONSTRAINT "REL_c785cb2b63d8a417fdcdfc2264" UNIQUE ("blogPostId"), CONSTRAINT "REL_3940732fa6499296a2006a5caf" UNIQUE ("destinationId"), CONSTRAINT "PK_20039129070a2e228880a2fcd3f" PRIMARY KEY ("id")); COMMENT ON COLUMN "file_archive"."fileUrl" IS 'Đường dẫn tệp'; COMMENT ON COLUMN "file_archive"."fileName" IS 'Tên tệp'; COMMENT ON COLUMN "file_archive"."description" IS 'Mô tả tệp'`,
    );
    await queryRunner.query(
      `CREATE TABLE "newsletter" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying(36) NOT NULL, "updatedAt" TIMESTAMP DEFAULT now(), "updatedBy" character varying(36), "isDeleted" boolean NOT NULL DEFAULT false, "email" character varying(255) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "subscribedAt" TIMESTAMP NOT NULL DEFAULT now(), "unsubscribedAt" TIMESTAMP, CONSTRAINT "PK_036bb790d1d19efeacfd2f3740c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tour_destinations" ADD CONSTRAINT "FK_ba6c822f3bacb20d662cdb65b57" FOREIGN KEY ("tourId") REFERENCES "tours"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_destinations" ADD CONSTRAINT "FK_fd78ecc761e62b02ab8053ea605" FOREIGN KEY ("destinationId") REFERENCES "destinations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "blog_posts" ADD CONSTRAINT "FK_09269227c7acf3cdf47ea4051e1" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "tour_destinations"`);
